...
public class SnakeWorld  extends World
{
    ...
    /**
     * act handles the actions that must be taken every time the progrm is run
     ...
     * @param dx is the new cooridnate of the Dot object
     * @return Nothing is returned
     */
     ...
     * @param d is the dot number
     * @param dy is the new cooridnate of the Dot object
     * @return Nothing is returned
     */
